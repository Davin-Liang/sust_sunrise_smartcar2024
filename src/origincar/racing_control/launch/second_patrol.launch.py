...
def generate_launch_description():
    ...
    prefix_path = os.path.expanduser("~/dev_ws/src/origincar/racing_control") # 可能路径不对
    config_file_path = os.path.join(prefix_path, "config/second_patrol.yaml")
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable='second_patrol',
            name='GetLineCoordinate_2',
            output='screen',
